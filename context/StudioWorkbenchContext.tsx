...
// This will get the parameters from ImageKit for authorized user
...
function useStudioWorkbenchValue({
	...
	// Flow: Validation (Error -> throw) -> Select Image -> ImageKit Upload -> Generate Response (Image) -> if Error -> Throw (and upadate Quota) -> Get generation -> Sentry Log -> Set UseStates (Result, History, Quota, Error, IsLoading)
