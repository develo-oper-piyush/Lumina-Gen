				...
				<div className="flex flex-col gap-6 border-b border-border/60 pb-8 lg:flex-row lg:items-end lg:justify-between">
					<div className="max-w-2xl">
						...
						<h2 className="mt-4 font-serif text-3xl leading-tight tracking-tight text-foreground sm:text-4xl">
							Classic, private, and beautifully focused AI style
							transfer.
						</h2>
						<p className="mt-4 text-sm leading-7 text-muted-foreground sm:text-base">
							Transform portraits and scenes with curated visual
							styles while keeping composition, subject identity,
							and overall image character at the center.
						</p>
					</div>
				...
				<div className="grid gap-8 pt-8 sm:grid-cols-2 lg:grid-cols-[1.2fr_0.8fr_1fr]">
					<div>
						...
						<p className="mt-4 max-w-md text-sm leading-7 text-muted-foreground">
							A premium studio for high-fidelity image restyling
							with curated presets, private results, and a calm
							workflow that feels polished from upload to final
							output.
						</p>
					</div>
